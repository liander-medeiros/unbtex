...
A \cref{tab:rot} foi construída com o ambiente \texttt{landscape} do pacote \textsf{lscape}. Para rotacionar, além da tabela, também a página do arquivo \texttt{pdf}, utilize o pacote \textsf{pdflscape}\footnote{Para mais informações, consulte: \url{https://mirrors.ctan.org/macros/latex/contrib/pdflscape/pdflscape.pdf}}. De forma análoga, os pacotes mencionados para rotacionar tabelas, podem rotacionar figuras.
...
\endhead
\hline
\multicolumn{8}{r}{\footnotesize(Continua)}\\
\endfoot
\bottomrule
\multicolumn{8}{c}{\footnotesize\fontename: Elaborada pelo autor}\\
\endlastfoot
